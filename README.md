...
<br/><br/>
<div  align="center"><img  width="700"  height="500"  src="https://github.com/HongLinLiao/votingVB/blob/master/IMG/addVote.PNG"/><br>建立投票(內容)</div>
<br/>
在指定內容填完資料後按下建立，會回到首頁
<br/><br/>
<div  align="center"><img  width="700"  height="200"  src="https://github.com/HongLinLiao/votingVB/blob/master/IMG/DB_Vote.PNG"/><br>DB(投票項目)</div>
<br/><br/>
<div  align="center"><img  width="700"  height="500"  src="https://github.com/HongLinLiao/votingVB/blob/master/IMG/resultPage.PNG"/><br>結果頁面</div>
<br/>
可以在結果頁面進行投票，每次進入結果頁面會先進資料庫抓取是否有投過票，再到頁面選擇呈現
<br/><br/>
<div  align="center"><img  width="700"  height="200"  src="https://github.com/HongLinLiao/votingVB/blob/master/IMG/DB_Choice.PNG"/><br>DB_投票總列表</div>
<br/>
